...
#pragma omp atomic
  ...
  // PERMUTE TUPLE GRAPH ///////////////////////
  fprintf(stderr, "%d: nedges = %" PRId64 " of %" PRId64 "\n", rank, (int64_t)tg.edgememory_size, (int64_t)tg.nglobaledges);
  ...
  apply_permutation_mpi(MPI_COMM_WORLD, perm_local_size, local_vertex_perm, nglobalverts, tg.edgememory_size, tg.edgememory);
