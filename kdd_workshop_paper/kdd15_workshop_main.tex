...
% \newcommand{\name}{VISAGE\xspace}
\newcommand{\xourname}{GSpot}
\newcommand{\name}{\textsc{\xourname}\xspace}
%\newcommand{\name}{AdaptiveNav\xspace}
\newcommand{\ourmethod}{\name}
\newcommand{\ourmethodtitle}{GSpot\xspace}
...
\title{GSpot (eheheh):\\Large Distributed Streaming Graph Partitioning}
...
% \alignauthor Richard Vuduc\\
       \affaddr{Georgia Institute of Ranch}\\
       \email{fieri@cc.gatech.edu}
%
}
